...
hoursT=tk.Label(top, text="Hours:")
hoursE=tk.Entry(top)
minuteT=tk.Label(top, text="Minutes:")
minuteE=tk.Entry(top)
secondT=tk.Label(top, text="Seconds:")
secondE=tk.Entry(top)
...
button=tk.Button(top,text="Start Timer",command=updateButton)
